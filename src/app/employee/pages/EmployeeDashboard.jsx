    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {showAttendanceHistory && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40 flex items-start justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-xl shadow-lg w-full sm:max-w-5xl mt-24 relative animate-fade-in">
            <button
      ...
      {showAttendanceForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="w-full sm:max-w-2xl max-h-[90vh] overflow-y-auto animate-fadeIn">
